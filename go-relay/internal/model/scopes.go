...
var ActionToScopeRequired = map[string]string{
	...
	"search":           ScopeSearch,
	"rolls":            ScopeRollRead,
	"lastroll":         ScopeRollRead,
	"roll":             ScopeRollExecute,
	"chat":             ScopeChatRead,
	"send-chat":        ScopeChatWrite,
