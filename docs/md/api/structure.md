...
```bash
curl -X GET 'http://localhost:3011/structure?clientId=qsl-integration-test&includeEntityData=true&recursive=true&types=Scene' \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /structure🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "structure_1782956918331",
  "data": {
    "folders": {
      "test-folder": {
        "id": "EaD5zungr24HhA1P",
        "uuid": "Folder.EaD5zungr24HhA1P",
        "type": "Scene"
      }
    },
    "entities": {
...
```bash
curl -X GET 'http://localhost:3011/get-folder?clientId=qsl-integration-test&name=test-folder' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /get-folder🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "get-folder_1782956918343",
  "data": {
    "id": "EaD5zungr24HhA1P",
    "uuid": "Folder.EaD5zungr24HhA1P",
    "name": "test-folder",
...
```bash
curl -X POST 'http://localhost:3011/create-folder?clientId=qsl-integration-test&name=test-folder&folderType=Scene' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /create-folder🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "create-folder_1782956918324",
  "data": {
    "id": "EaD5zungr24HhA1P",
    "uuid": "Folder.EaD5zungr24HhA1P",
    "name": "test-folder",
...
```bash
curl -X DELETE 'http://localhost:3011/delete-folder?clientId=qsl-integration-test&folderId=EaD5zungr24HhA1P' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Query parameters
  🔤clientId=qsl-integration-test🔤 ➡️ clientId
  🔤folderId=EaD5zungr24HhA1P🔤 ➡️ folderId
  🔤?🧲clientId🧲&🧲folderId🧲🔤 ➡️ queryString

  💭 Build HTTP request
  🔤DELETE /delete-folder🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "delete-folder_1782956918345",
  "data": {
    "deleted": true,
    "folderId": "EaD5zungr24HhA1P",
    "entitiesDeleted": 0,
