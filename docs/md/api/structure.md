...
```bash
curl -X GET 'http://localhost:3010/structure?clientId=fvtt_d3db244ce1d8af0b&includeEntityData=true&recursive=true&types=Scene' \
...
```json
{
  ...
  "requestId": "structure_1780520763978",
  "data": {
    "folders": {
      "test-folder": {
        "id": "RVOrQr7WB9t9XN0S",
        "uuid": "Folder.RVOrQr7WB9t9XN0S",
        "type": "Scene"
      }
    },
    "entities": {
      "scenes": [
        ...
        },
        {
          ...
          "tokens": [
            {
              "_id": "J70b8Sc9pBiP62Fa",
              "name": "Unknown",
              "displayName": 0,
              "actorId": "buygXx2yxLXmmrjH",
              "actorLink": false,
              "delta": {
                "_id": "IpzQdn95oqV7dzZF",
                "system": {},
                "items": [],
                "effects": [],
                "flags": {}
          ...
          "_stats": {
            ...
            "systemId": "dnd5e",
            "systemVersion": "4.3.8",
            "createdTime": 1780331026385,
            "modifiedTime": 1780519593061,
            "lastModifiedBy": "fCfNJPT9Atc26yyv",
            "compendiumSource": null,
            "duplicateSource": null
          }
        ...
        },
        {
          ...
          "tokens": [
            {
              "_id": "IFvYJKPvTx9b6rNm",
              "name": "Updated Test Actor",
              "displayName": 0,
              "actorId": "u3iSEGYdk5UNZy7X",
              "actorLink": false,
              "delta": {
                "_id": "AZlhHHxzIW4XBKam",
                "type": "character",
                "system": {},
                "items": [
                  {
          ...
          "_stats": {
            ...
            "systemId": "dnd5e",
            "systemVersion": "4.3.8",
            "createdTime": 1780520747075,
            "modifiedTime": 1780520747103,
            "lastModifiedBy": "fCfNJPT9Atc26yyv",
            "compendiumSource": null,
            "duplicateSource": null
          }
...
```bash
curl -X GET 'http://localhost:3010/get-folder?clientId=fvtt_d3db244ce1d8af0b&name=test-folder' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "get-folder_1780520763999",
  "data": {
    "id": "RVOrQr7WB9t9XN0S",
    "uuid": "Folder.RVOrQr7WB9t9XN0S",
    "name": "test-folder",
...
```bash
curl -X POST 'http://localhost:3010/create-folder?clientId=fvtt_d3db244ce1d8af0b&name=test-folder&folderType=Scene' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "create-folder_1780520763972",
  "data": {
    "id": "RVOrQr7WB9t9XN0S",
    "uuid": "Folder.RVOrQr7WB9t9XN0S",
    "name": "test-folder",
...
```bash
curl -X DELETE 'http://localhost:3010/delete-folder?clientId=fvtt_d3db244ce1d8af0b&folderId=RVOrQr7WB9t9XN0S' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Query parameters
  🔤clientId=fvtt_d3db244ce1d8af0b🔤 ➡️ clientId
  🔤folderId=RVOrQr7WB9t9XN0S🔤 ➡️ folderId
...
```json
{
  ...
  "requestId": "delete-folder_1780520764002",
  "data": {
    "deleted": true,
    "folderId": "RVOrQr7WB9t9XN0S",
    "entitiesDeleted": 0,
