...
```bash
curl -X POST 'http://localhost:3010/select?clientId=fvtt_d3db244ce1d8af0b' \
...
{
  "type": "select-result",
  "requestId": "select_1780520794944",
  "success": true,
  "count": 1,
...
```bash
curl -X GET 'http://localhost:3010/selected?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "selected_1780520794949",
  "success": true,
  "selected": [
    {
...
```bash
curl -X GET 'http://localhost:3010/players?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here"
```
...
{
  "type": "players-result",
  "requestId": "players_1780520794951",
  "users": [
    {
      "id": "vXdyKYLgpmko3kHx",
      "name": "Gamemaster",
...
```bash
curl -X GET 'http://localhost:3010/world-info?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "world-info_1780520794973",
  "data": {
    "world": {
      "id": "rest-api",
      "title": "rest-api"
...
```bash
curl -X POST 'http://localhost:3010/execute-js?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
...
```json
{
  ...
  "requestId": "execute-js_1780520794952",
  "success": true,
