...
```bash
curl -X GET 'http://localhost:3010/playlists?clientId=fvtt_d3db244ce1d8af0b' \
...
```json
{
  ...
  "requestId": "get-playlists_1780520802414",
  "data": {
    "playlists": [
      {
        "id": "oR7ZKnnoLVzLwTdA",
...
```bash
curl -X POST 'http://localhost:3010/playlist/play?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
...
```json
{
  ...
  "requestId": "playlist-play_1780520802418",
  "data": {
    "playlist": {
      "id": "oR7ZKnnoLVzLwTdA",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3010/playlist/stop?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"playlistName":"test-rest-api-playlist"}'
```
...
```json
{
  ...
  "requestId": "playlist-stop_1780520802430",
  "data": {
    "playlist": {
      "id": "oR7ZKnnoLVzLwTdA",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3010/playlist/next?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"playlistName":"test-rest-api-playlist"}'
```
...
```json
{
  ...
  "requestId": "playlist-next_1780520802423",
  "data": {
    "playlist": {
      "id": "oR7ZKnnoLVzLwTdA",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3010/playlist/volume?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
...
```json
{
  ...
  "requestId": "playlist-volume_1780520802426",
  "data": {
    "playlist": {
      "id": "oR7ZKnnoLVzLwTdA",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3010/stop-sound?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
...
```json
{
  ...
  "requestId": "stop-sound_1780520802436",
  "data": {
    "stopped": 0,
    "src": "sounds/dice.wav"
  }
