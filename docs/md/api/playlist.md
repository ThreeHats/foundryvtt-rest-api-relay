...
```bash
curl -X GET 'http://localhost:3011/playlists?clientId=qsl-integration-test' \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /playlists🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "get-playlists_1782956932700",
  "data": {
    "playlists": [
      {
        "id": "QeQWR98JSuzsKEMt",
...
```bash
curl -X POST 'http://localhost:3011/playlist/play?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /playlist/play🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 41❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "playlist-play_1782956932703",
  "data": {
    "playlist": {
      "id": "QeQWR98JSuzsKEMt",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3011/playlist/stop?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"playlistName":"test-rest-api-playlist"}'
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /playlist/stop🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 41❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "playlist-stop_1782956932713",
  "data": {
    "playlist": {
      "id": "QeQWR98JSuzsKEMt",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3011/playlist/next?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"playlistName":"test-rest-api-playlist"}'
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /playlist/next🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 41❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "playlist-next_1782956932709",
  "data": {
    "playlist": {
      "id": "QeQWR98JSuzsKEMt",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3011/playlist/volume?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /playlist/volume🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 55❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "playlist-volume_1782956932712",
  "data": {
    "playlist": {
      "id": "QeQWR98JSuzsKEMt",
      "name": "test-rest-api-playlist",
...
```bash
curl -X POST 'http://localhost:3011/stop-sound?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /stop-sound🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 25❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "stop-sound_1782956932719",
  "data": {
    "stopped": 0,
    "src": "sounds/dice.wav"
  }
