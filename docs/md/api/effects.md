...
```bash
curl -X GET 'http://localhost:3010/effects?clientId=fvtt_d3db244ce1d8af0b&uuid=Actor.u3iSEGYdk5UNZy7X' \
...
🏁 🍇
  ...
  🔤uuid=Actor.u3iSEGYdk5UNZy7X🔤 ➡️ uuid
...
```json
{
  ...
  "requestId": "get-effects_1780520807048",
  "data": {
    "uuid": "Actor.u3iSEGYdk5UNZy7X",
    "effects": []
  }
...
```bash
curl -X GET 'http://localhost:3010/effects/list?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "get-status-effects_1780520807043",
  "data": {
    "effects": [
      {
        "id": "dead",
...
```bash
curl -X POST 'http://localhost:3010/effects?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"uuid":"Actor.u3iSEGYdk5UNZy7X","effectData":{"name":"Test Effect","icon":"icons/svg/aura.svg","changes":[]}}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"uuid":"Actor.u3iSEGYdk5UNZy7X","effectData":{"name":"Test Effect","icon":"icons/svg/aura.svg","changes":[]}}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "add-effect_1780520807051",
  "data": {
    "uuid": "Actor.u3iSEGYdk5UNZy7X",
    "effect": {
      "id": "pchhGxLxlRFJ8id6",
      "uuid": "Actor.u3iSEGYdk5UNZy7X.ActiveEffect.pchhGxLxlRFJ8id6",
      "name": "Test Effect",
      "icon": "icons/svg/aura.svg",
      "statuses": []
    }
...
```bash
curl -X DELETE 'http://localhost:3010/effects?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"uuid":"Actor.u3iSEGYdk5UNZy7X","effectId":"pchhGxLxlRFJ8id6"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"uuid":"Actor.u3iSEGYdk5UNZy7X","effectId":"pchhGxLxlRFJ8id6"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "remove-effect_1780520807135",
  "data": {
    "uuid": "Actor.u3iSEGYdk5UNZy7X",
    "removedEffectId": "pchhGxLxlRFJ8id6"
  }
}
```
