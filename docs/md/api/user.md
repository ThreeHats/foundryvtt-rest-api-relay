...
```bash
curl -X GET 'http://localhost:3010/users?clientId=fvtt_d3db244ce1d8af0b' \
...
```json
{
  ...
  "requestId": "get-users_1780520806818",
  "data": [
    {
      "id": "vXdyKYLgpmko3kHx",
      "name": "Gamemaster",
...
```bash
curl -X GET 'http://localhost:3010/user?clientId=fvtt_d3db244ce1d8af0b&id=hsoyUqz1AdqBpdVx' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "get-user_1780520806829",
  "data": {
    "id": "hsoyUqz1AdqBpdVx",
    "name": "test-api-user",
    "role": 1,
...
```bash
curl -X POST 'http://localhost:3010/user?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
...
```json
{
  ...
  "requestId": "create-user_1780520806820",
  "data": {
    "id": "hsoyUqz1AdqBpdVx",
    "name": "test-api-user",
    "role": 1,
...
```bash
curl -X PUT 'http://localhost:3010/user?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"id":"hsoyUqz1AdqBpdVx","data":{"role":2}}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"id":"hsoyUqz1AdqBpdVx","data":{"role":2}}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "update-user_1780520806833",
  "data": {
    "id": "hsoyUqz1AdqBpdVx",
    "name": "test-api-user",
    "role": 2,
...
```bash
curl -X DELETE 'http://localhost:3010/user?clientId=fvtt_d3db244ce1d8af0b&id=hsoyUqz1AdqBpdVx' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "delete-user_1780520806840",
  "success": true
}
```
