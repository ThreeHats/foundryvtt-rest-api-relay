...
const params = {
  ...
  actorUuid: 'Actor.V5OF1QXHjaIy6iO8',
...
```bash
curl -X GET 'http://localhost:3011/dnd5e/get-actor-details?clientId=qsl-integration-test&actorUuid=Actor.V5OF1QXHjaIy6iO8&details=%5B%22resources%22%2C%22items%22%2C%22features%22%2C%22spells%22%5D' \
...
🏁 🍇
  ...
  🔤actorUuid=Actor.V5OF1QXHjaIy6iO8🔤 ➡️ actorUuid
  🔤details=["resources","items","features","spells"]🔤 ➡️ details
  🔤?🧲clientId🧲&🧲actorUuid🧲&🧲details🧲🔤 ➡️ queryString

  💭 Build HTTP request
  🔤GET /dnd5e/get-actor-details🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "get-actor-details_1782956935695",
  "data": {
        ...
        "effects": [
          {
            ...
            "_stats": {
              ...
              "coreVersion": "14.363",
              "createdTime": 1782956935490,
              "duplicateSource": null,
              "exportSource": null,
              "lastModifiedBy": "cpvaGKk3hgoBCzCS",
              "modifiedTime": 1782956935490,
              "systemId": "dnd5e",
              "systemVersion": "5.0.4"
            },
            "description": "",
    ...
    "items": [
      {
        ...
        "_stats": {
          ...
          "coreVersion": "14.363",
          "createdTime": 1782956904858,
          "duplicateSource": null,
          "exportSource": null,
          "lastModifiedBy": "cpvaGKk3hgoBCzCS",
          "modifiedTime": 1782956904858,
          "systemId": "dnd5e",
          "systemVersion": "5.0.4"
        },
        "effects": [],
      ...
      },
      {
        ...
        "_stats": {
          ...
          "systemId": "dnd5e",
          "systemVersion": "5.0.4",
          "createdTime": 1782956935623,
          "modifiedTime": 1782956935623,
          "lastModifiedBy": "cpvaGKk3hgoBCzCS",
          "compendiumSource": null,
          "duplicateSource": null,
          "exportSource": null
        },
        "_id": "WwRMQKOlAvEpD3ca"
      }
    ],
    "features": [
      {
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/modify-item-charges?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","itemName":"Waterskin","amount":-1}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","itemName":"Waterskin","amount":-1}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/modify-item-charges🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 73❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "modify-item-charges_1782956935872",
  "data": {
    "itemUuid": "Actor.V5OF1QXHjaIy6iO8.Item.5skKSSB4ShHbKoc8",
    "oldCharges": 4,
    "newCharges": 3
  }
}
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/short-rest?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8"}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/short-rest🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 38❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "short-rest_1782956936201",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "result": {
      "type": "short",
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/long-rest?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","newDay":true}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","newDay":true}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/long-rest🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 52❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "long-rest_1782956936321",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "result": {
      "type": "long",
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/skill-check?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","skill":"prc"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","skill":"prc"}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/skill-check🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 52❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "skill-check_1782956936093",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "skill": "prc",
    "total": 14,
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/ability-save?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","ability":"dex"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","ability":"dex"}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/ability-save🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 54❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "ability-save_1782956936104",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "ability": "dex",
    "total": 2,
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/ability-check?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","ability":"str"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","ability":"str"}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/ability-check🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 54❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "ability-check_1782956936109",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "ability": "str",
    "total": 15,
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/death-save?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8"}'
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /dnd5e/death-save🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 38❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "death-save_1782956936114",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "total": 16,
    "formula": "1d20",
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/modify-experience?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","amount":100}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","amount":100}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/modify-experience🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 51❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "modify-experience_1782956935706",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "oldXp": 0,
    "newXp": 100
...
```bash
curl -X GET 'http://localhost:3011/dnd5e/concentration?clientId=qsl-integration-test&actorUuid=Actor.V5OF1QXHjaIy6iO8' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /dnd5e/concentration🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "get-concentration_1782956936438",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/break-concentration?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8"}'
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /dnd5e/break-concentration🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 38❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "break-concentration_1782956936532",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "broken": true,
    "removedEffectId": "5JqtFclmzmwMNV3c"
  }
}
```
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/concentration-save?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","damage":15}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","damage":15}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/concentration-save🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 50❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "concentration-save_1782956936528",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "dc": 10,
    "total": 13,
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/equip-item?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","itemName":"Dart","equipped":true}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","itemName":"Dart","equipped":true}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/equip-item🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 72❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "equip-item_1782956936564",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "itemUuid": "Actor.V5OF1QXHjaIy6iO8.Item.WeKJI3gPUAU52WAX",
    "itemName": "Dart",
    "equipped": true
  }
}
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/attune-item?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","itemName":"Dart","attuned":true}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","itemName":"Dart","attuned":true}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/attune-item🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 71❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "attune-item_1782956936760",
  "data": {
    "actorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "itemUuid": "Actor.V5OF1QXHjaIy6iO8.Item.WeKJI3gPUAU52WAX",
    "itemName": "Dart",
...
const response = await fetch(url, {
  ...
  body: JSON.stringify({
      "sourceActorUuid": "Actor.V5OF1QXHjaIy6iO8",
      "targetActorUuid": "Actor.w8wIGpE73y2AYrCo",
      "currency": {
        "gp": 1
      }
    })
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/transfer-currency?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"sourceActorUuid":"Actor.V5OF1QXHjaIy6iO8","targetActorUuid":"Actor.w8wIGpE73y2AYrCo","currency":{"gp":1}}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"sourceActorUuid":"Actor.V5OF1QXHjaIy6iO8","targetActorUuid":"Actor.w8wIGpE73y2AYrCo","currency":{"gp":1}}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/transfer-currency🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 107❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "transfer-currency_1782956936931",
  "data": {
    "sourceActorUuid": "Actor.V5OF1QXHjaIy6iO8",
    "targetActorUuid": "Actor.w8wIGpE73y2AYrCo",
    "transferred": {
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/use-ability?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","abilityName":"Hammer"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","abilityName":"Hammer"}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/use-ability🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 61❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "use-ability_1782956936085",
  "data": {
    "uuid": "Actor.V5OF1QXHjaIy6iO8",
    "ability": "Hammer"
  }
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/use-feature?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","abilityName":"Priest"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","abilityName":"Priest"}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/use-feature🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 61❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "use-feature_1782956936062",
  "data": {
    "uuid": "Actor.V5OF1QXHjaIy6iO8",
    "ability": "Priest"
  }
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/use-spell?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","abilityName":"test-polymorph"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","abilityName":"test-polymorph"}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /dnd5e/use-spell🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 69❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "use-spell_1782956936071",
  "data": {
    "uuid": "Actor.V5OF1QXHjaIy6iO8",
...
```bash
curl -X POST 'http://localhost:3011/dnd5e/use-item?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.V5OF1QXHjaIy6iO8","abilityName":"Hammer"}'
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /dnd5e/use-item🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 61❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "use-item_1782956936044",
  "data": {
    "uuid": "Actor.V5OF1QXHjaIy6iO8",
    "ability": "Hammer"
  }
