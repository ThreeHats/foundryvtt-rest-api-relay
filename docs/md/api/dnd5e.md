...
const params = {
  ...
  actorUuid: 'Actor.u3iSEGYdk5UNZy7X',
...
```bash
curl -X GET 'http://localhost:3010/dnd5e/get-actor-details?clientId=fvtt_d3db244ce1d8af0b&actorUuid=Actor.u3iSEGYdk5UNZy7X&details=%5B%22resources%22%2C%22items%22%2C%22features%22%2C%22spells%22%5D' \
...
🏁 🍇
  ...
  🔤actorUuid=Actor.u3iSEGYdk5UNZy7X🔤 ➡️ actorUuid
...
```json
{
  ...
  "requestId": "get-actor-details_1780520808046",
  "data": {
    ...
    "spells": [
      {
        ...
        "_stats": {
          ...
          "systemId": "dnd5e",
          "systemVersion": "4.3.8",
          "createdTime": 1780520807828,
          "modifiedTime": 1780520807828,
          "lastModifiedBy": "fCfNJPT9Atc26yyv"
        },
        "_id": "LnGvWfPyEbM77jVT"
      }
    ],
    "spellSlots": {},
    "items": [
      ...
      },
      {
        ...
        "_stats": {
          ...
          "systemId": "dnd5e",
          "systemVersion": "4.3.8",
          "createdTime": 1780520807965,
          "modifiedTime": 1780520807965,
          "lastModifiedBy": "fCfNJPT9Atc26yyv"
        },
        "_id": "lyO8caL9WN3RbDHN"
      }
    ],
    "features": [
      {
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/modify-item-charges?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","itemName":"Waterskin","amount":-1}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","itemName":"Waterskin","amount":-1}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "modify-item-charges_1780520808202",
  "data": {
    "itemUuid": "Actor.u3iSEGYdk5UNZy7X.Item.5skKSSB4ShHbKoc8",
    "oldCharges": 4,
    "newCharges": 3
  }
}
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/short-rest?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "short-rest_1780520808687",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "result": {
      "type": "short",
      ...
      "clone": {
        "effects": [
          {
            ...
            "_stats": {
              ...
              "systemId": "dnd5e",
              "systemVersion": "4.3.8",
              "createdTime": 1780520808566,
              "modifiedTime": 1780520808566,
              "lastModifiedBy": "fCfNJPT9Atc26yyv"
            }
          }
        ],
        ...
        "_stats": {
          ...
          "systemId": "dnd5e",
          "systemVersion": "4.3.8",
          "createdTime": 1780520739083,
          "modifiedTime": 1780520808628,
          "lastModifiedBy": "fCfNJPT9Atc26yyv"
        },
        "_id": null
      },
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/long-rest?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","newDay":true}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","newDay":true}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "long-rest_1780520808721",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "result": {
      "type": "long",
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/skill-check?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","skill":"prc"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","skill":"prc"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "skill-check_1780520808420",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "skill": "prc",
    "total": 11,
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/ability-save?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","ability":"dex"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","ability":"dex"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "ability-save_1780520808441",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "ability": "dex",
    "total": 16,
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/ability-check?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","ability":"str"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","ability":"str"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "ability-check_1780520808456",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "ability": "str",
    "total": 10,
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/death-save?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X"}'
```
...
```json
{
  ...
  "requestId": "death-save_1780520808563",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "total": 14,
    "formula": "1d20",
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/modify-experience?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","amount":100}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","amount":100}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "modify-experience_1780520808057",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "oldXp": 0,
    "newXp": 100
...
```bash
curl -X GET 'http://localhost:3010/dnd5e/concentration?clientId=fvtt_d3db244ce1d8af0b&actorUuid=Actor.u3iSEGYdk5UNZy7X' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "get-concentration_1780520808880",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/break-concentration?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X"}'
```
...
```json
{
  ...
  "requestId": "break-concentration_1780520808954",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "broken": true,
    "removedEffectId": "z0KCaQVBA55JIjsi"
  }
}
```
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/concentration-save?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","damage":15}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","damage":15}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "concentration-save_1780520808945",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "dc": 10,
    "total": 10,
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/equip-item?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","itemName":"Dart","equipped":true}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","itemName":"Dart","equipped":true}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "equip-item_1780520809024",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "itemUuid": "Actor.u3iSEGYdk5UNZy7X.Item.WeKJI3gPUAU52WAX",
    "itemName": "Dart",
    "equipped": true
  }
}
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/attune-item?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","itemName":"Dart","attuned":true}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","itemName":"Dart","attuned":true}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "attune-item_1780520809026",
  "data": {
    "actorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "itemUuid": "Actor.u3iSEGYdk5UNZy7X.Item.WeKJI3gPUAU52WAX",
    "itemName": "Dart",
...
const response = await fetch(url, {
  ...
  body: JSON.stringify({
      "sourceActorUuid": "Actor.u3iSEGYdk5UNZy7X",
      "targetActorUuid": "Actor.3Uhyx1yXkrDR0IKP",
      "currency": {
        "gp": 1
      }
    })
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/transfer-currency?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"sourceActorUuid":"Actor.u3iSEGYdk5UNZy7X","targetActorUuid":"Actor.3Uhyx1yXkrDR0IKP","currency":{"gp":1}}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"sourceActorUuid":"Actor.u3iSEGYdk5UNZy7X","targetActorUuid":"Actor.3Uhyx1yXkrDR0IKP","currency":{"gp":1}}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "transfer-currency_1780520809093",
  "data": {
    "sourceActorUuid": "Actor.u3iSEGYdk5UNZy7X",
    "targetActorUuid": "Actor.3Uhyx1yXkrDR0IKP",
    "transferred": {
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/use-ability?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","abilityName":"Hammer"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","abilityName":"Hammer"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "use-ability_1780520808411",
  "data": {
    "uuid": "Actor.u3iSEGYdk5UNZy7X",
    "ability": "Hammer",
    "result": "3qYJdHLSGNzVsYnV"
  }
}
```
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/use-feature?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","abilityName":"Priest"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","abilityName":"Priest"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "use-feature_1780520808390",
  "data": {
    "uuid": "Actor.u3iSEGYdk5UNZy7X",
    "ability": "Priest",
    "result": "Imk1bHv58F7vEugf"
  }
}
```
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/use-spell?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","abilityName":"test-polymorph"}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","abilityName":"test-polymorph"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "use-spell_1780520808399",
  "data": {
    "uuid": "Actor.u3iSEGYdk5UNZy7X",
...
```bash
curl -X POST 'http://localhost:3010/dnd5e/use-item?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"actorUuid":"Actor.u3iSEGYdk5UNZy7X","abilityName":"Hammer"}'
```
...
```json
{
  ...
  "requestId": "use-item_1780520808374",
  "data": {
    "uuid": "Actor.u3iSEGYdk5UNZy7X",
    "ability": "Hammer",
    "result": "Eyk960rz5VeEjZYd"
  }
}
```
