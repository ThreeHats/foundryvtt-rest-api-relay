...
```json
{
  ...
  "requestId": "get-scene_1778789863808",
  "data": [
    {
      "name": "Scene",
    ...
    },
    {
      ...
      "_stats": {
        ...
        "systemId": "dnd5e",
        "systemVersion": "5.0.4",
        "createdTime": 1778789863802,
        "modifiedTime": 1778789863802,
        "lastModifiedBy": "r6bXhB7k9cXa3cif"
      }
    }
  ]
...
```json
{
  ...
  "requestId": "create-scene_1778789863791",
  "data": {
    "grid": {
      "size": 100,
      "type": 1,
...
curl -X PUT 'http://localhost:3010/scene?clientId=fvtt_099ad17ea199e7e3' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"sceneId":"Jz0KV1jlNI0jdQp0","data":{"name":"test-scene-updated"}}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"sceneId":"Jz0KV1jlNI0jdQp0","data":{"name":"test-scene-updated"}}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "update-scene_1778789863819",
  "data": {
    "grid": {
      "size": 100,
      "type": 1,
...
```bash
curl -X DELETE 'http://localhost:3010/scene?clientId=fvtt_099ad17ea199e7e3&sceneId=6AqMvMdSVPoNB9ev' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Query parameters
  🔤clientId=fvtt_099ad17ea199e7e3🔤 ➡️ clientId
  🔤sceneId=6AqMvMdSVPoNB9ev🔤 ➡️ sceneId
...
```json
{
  ...
  "requestId": "delete-scene_1778789868843",
  "success": true
}
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"sceneId":"Jz0KV1jlNI0jdQp0"}🔤 ➡️ body
...
```json
{
  ...
  "requestId": "switch-scene_1778789863825",
  "success": true,
  "data": {
    "grid": {
      "size": 100,
