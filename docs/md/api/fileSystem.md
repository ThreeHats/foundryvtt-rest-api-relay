...
```bash
curl -X GET 'http://localhost:3010/file-system?clientId=fvtt_d3db244ce1d8af0b&source=data&recursive=false' \
...
```json
{
  ...
  "requestId": "file-system_1780520795607",
  "success": true,
  "path": "",
  "source": "data",
  "results": [
...
```bash
curl -X GET 'http://localhost:3010/download?clientId=fvtt_d3db244ce1d8af0b&path=rest-api-tests%2Ftest-file.txt&source=data&format=base64' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "mimeType": "text/plain",
  "path": "rest-api-tests/test-file.txt",
  "requestId": "download-file_1780520795611",
  "success": true,
...
```bash
curl -X POST 'http://localhost:3010/upload?clientId=fvtt_d3db244ce1d8af0b&path=rest-api-tests&source=data&filename=test-file.txt&mimeType=text%2Fplain' \
  -H "x-api-key: your-api-key-here" \
...
```json
{
  ...
  "requestId": "upload-file_1780520795594",
  "success": true,
  "path": "rest-api-tests/test-file.txt"
}
```
