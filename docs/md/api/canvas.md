...
```bash
curl -X GET 'http://localhost:3011/canvas/tokens?clientId=qsl-integration-test' \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /canvas/tokens🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "get-canvas-documents_1782956917876",
  "sceneId": "SM7AhDv5JgZh6IvK",
  "documentType": "tokens",
  "data": [
    {
      "actorId": "V5OF1QXHjaIy6iO8",
      "x": 400,
      "y": 400,
      "shape": 4,
      "level": "defaultLevel0000",
      "_id": "GDOucEcvorBe3Ps2",
      "name": "",
      "displayName": 0,
      "actorLink": false,
      "delta": null,
...
```bash
curl -X GET 'http://localhost:3011/measure-distance?clientId=qsl-integration-test&originX=0&originY=0&targetX=500&targetY=500' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /measure-distance🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "measure-distance_1782956918175",
  "data": {
    "distance": 25,
    "units": "ft",
    "origin": {
...
```bash
curl -X POST 'http://localhost:3011/canvas/tokens?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"data":{"x":400,"y":400,"actorId":"V5OF1QXHjaIy6iO8"}}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"data":{"x":400,"y":400,"actorId":"V5OF1QXHjaIy6iO8"}}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /canvas/tokens🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 55❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "create-canvas-document_1782956917778",
  "sceneId": "SM7AhDv5JgZh6IvK",
  "documentType": "tokens",
  "data": [
    {
...
```bash
curl -X PUT 'http://localhost:3011/canvas/tokens?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"documentId":"GDOucEcvorBe3Ps2","data":{"x":450,"y":450}}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"documentId":"GDOucEcvorBe3Ps2","data":{"x":450,"y":450}}🔤 ➡️ body

  💭 Build HTTP request
  🔤PUT /canvas/tokens🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 58❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "update-canvas-document_1782956917881",
  "sceneId": "SM7AhDv5JgZh6IvK",
  "documentType": "tokens",
  "data": [
    {
...
```bash
curl -X DELETE 'http://localhost:3011/canvas/tokens?clientId=qsl-integration-test&documentId=GDOucEcvorBe3Ps2' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Query parameters
  🔤clientId=qsl-integration-test🔤 ➡️ clientId
  🔤documentId=GDOucEcvorBe3Ps2🔤 ➡️ documentId
  🔤?🧲clientId🧲&🧲documentId🧲🔤 ➡️ queryString

  💭 Build HTTP request
  🔤DELETE /canvas/tokens🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "delete-canvas-document_1782956917915",
  "sceneId": "SM7AhDv5JgZh6IvK",
  "documentType": "tokens",
  "success": true
}
...
```bash
curl -X POST 'http://localhost:3011/move-token?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
  -H "Content-Type: application/json" \
  -d '{"uuid":"Actor.V5OF1QXHjaIy6iO8","x":200,"y":200,"animate":false}'
```
...
🏁 🍇
  ...
  💭 Request body
  🔤{"uuid":"Actor.V5OF1QXHjaIy6iO8","x":200,"y":200,"animate":false}🔤 ➡️ body

  💭 Build HTTP request
  🔤POST /move-token🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 65❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
...
```json
{
  ...
  "requestId": "move-token_1782956918149",
  "data": {
