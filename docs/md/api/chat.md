...
```bash
curl -X GET 'http://localhost:3010/chat?clientId=fvtt_d3db244ce1d8af0b&limit=10' \
...
```json
{
  ...
  "requestId": "chat-messages_1780520795841",
  "success": true,
  "data": {
    "messages": [
      {
        "id": "ebqvMJ3htv8huIXU",
        "uuid": "ChatMessage.ebqvMJ3htv8huIXU",
      ...
      {
        "id": "b4VlvhmspvAoORpv",
        "uuid": "ChatMessage.b4VlvhmspvAoORpv",
      ...
      {
        "id": "BTMIePPJJXh3ijZm",
        "uuid": "ChatMessage.BTMIePPJJXh3ijZm",
        "content": "12",
        "speaker": {
          "scene": "Lxz4vYKs8VE4gpcw",
          "actor": "u3iSEGYdk5UNZy7X",
          "token": "IFvYJKPvTx9b6rNm",
          "alias": "Updated Test Actor"
        },
        "timestamp": 1780520795242,
        "whisper": [],
        "type": "base",
        "author": {
          "id": "fCfNJPT9Atc26yyv",
      ...
      {
        "id": "IjEnQczHk5LOQYVm",
        "uuid": "ChatMessage.IjEnQczHk5LOQYVm",
        "content": "7",
        "speaker": {
          "scene": "Lxz4vYKs8VE4gpcw",
          "actor": "u3iSEGYdk5UNZy7X",
      ...
      {
        "id": "ZUvdDikeTIHmIu3a",
        "uuid": "ChatMessage.ZUvdDikeTIHmIu3a",
      ...
      {
        "id": "UZt6KLsFGPFqlko9",
        "uuid": "ChatMessage.UZt6KLsFGPFqlko9",
        "content": "<b>⚠ REST API macro-execute:</b> <code>test-macro</code> (Macro.3bMxRd6G3ULP6qKD)",
        "speaker": {
          "scene": null,
          "actor": null,
          "token": null,
      ...
      {
        "id": "EeNCkvN2wIqzOS8H",
        "uuid": "ChatMessage.EeNCkvN2wIqzOS8H",
        "content": "17",
        "speaker": {
          "scene": null,
          "actor": null,
      ...
      {
        "id": "KugA8IpsJwRIh2WW",
        "uuid": "ChatMessage.KugA8IpsJwRIh2WW",
        "content": "3",
        "speaker": {
          "scene": null,
          "actor": null,
      ...
      {
        "id": "Z2FI0RWHgB0bfBZY",
        "uuid": "ChatMessage.Z2FI0RWHgB0bfBZY",
      ...
      {
        "id": "7rkUTfWPqEahRO0z",
        "uuid": "ChatMessage.7rkUTfWPqEahRO0z",
        "content": "",
        "speaker": {
          "scene": "O4QVJJohU6H30LWQ",
          "actor": "kYYpu1p0lssxxmxL",
          "token": "cjWr9mf2KGAwEquR",
          "alias": "Updated Test Actor"
        },
        "timestamp": 1780519582153,
        "whisper": [],
        "type": "base",
        "author": {
          "id": "fCfNJPT9Atc26yyv",
...
```bash
curl -X POST 'http://localhost:3010/chat?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
...
```json
{
  ...
  "requestId": "chat-send_1780520795832",
  "success": true,
  "data": {
    "id": "b4VlvhmspvAoORpv",
    "uuid": "ChatMessage.b4VlvhmspvAoORpv",
...
```javascript
const baseUrl = 'http://localhost:3010';
const path = '/chat/b4VlvhmspvAoORpv';
const params = {
  clientId: 'fvtt_d3db244ce1d8af0b'
};
const queryString = new URLSearchParams(params).toString();
...
```bash
curl -X DELETE 'http://localhost:3010/chat/b4VlvhmspvAoORpv?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤DELETE /chat/b4VlvhmspvAoORpv🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3010❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "chat-delete_1780520795849",
  "success": true,
  "data": {
    "messageId": "b4VlvhmspvAoORpv"
  }
}
```
...
```bash
curl -X DELETE 'http://localhost:3010/chat?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "chat-flush_1780520795859",
  "success": true,
  "data": {
