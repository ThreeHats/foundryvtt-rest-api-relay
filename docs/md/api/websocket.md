...
async def main():
    uri = 'ws://localhost:3011/ws/api?clientId=YOUR_CLIENT_ID'
...
```json
{
  ...
  "query": "test",
  "requestId": "test_1782956933625_v13y2n",
  "results": [
    {
      "documentType": "Scene",
      "folder": null,
      ...
      "icon": "",
      "id": "UTjLwXV2Zl26XPRl",
      "journalLink": "@UUID[Scene.UTjLwXV2Zl26XPRl]{test}",
      "name": "test",
      "package": null,
      "packageName": null,
    ...
    },
    {
      ...
      "icon": "",
      "id": "u2AiIrFkEH3yLtCK",
      "journalLink": "@UUID[JournalEntry.u2AiIrFkEH3yLtCK]{test-journalentry}",
      ...
      "uuid": "JournalEntry.u2AiIrFkEH3yLtCK"
    },
    {
      "documentType": "Macro",
      "folder": null,
      ...
      "id": "7zDXWfoXIJPrJ7uh",
      "journalLink": "@UUID[Macro.7zDXWfoXIJPrJ7uh]{test-macro}",
      "name": "test-macro",
      "package": null,
      "packageName": null,
      "resultType": "WorldEntity",
    ...
    },
    {
      ...
      "icon": "",
      "id": "SM7AhDv5JgZh6IvK",
      "journalLink": "@UUID[Scene.SM7AhDv5JgZh6IvK]{test-scene-updated}",
    ...
    },
    {
      ...
      "id": "oPzBJWyEbFVY2Mdp",
      "journalLink": "@UUID[Item.oPzBJWyEbFVY2Mdp]{test-studded leather armor +3}",
  ...
  "data": {
    "data": {
      "data": {
        ...
        "timestamp": 1782956933731,
        "type": "base",
        "uuid": "ChatMessage.Z54Z52wDOqYQaLMe",
        "whisper": []
      },
      "eventType": "create"
    },
