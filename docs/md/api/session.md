...
```json
{
  ...
  "sessionId": "13b76929-381f-48b6-a7a6-ae9cd26e95cc",
  "success": true
}
```
...
```bash
curl -X DELETE 'http://localhost:3010/end-session?sessionId=13b76929-381f-48b6-a7a6-ae9cd26e95cc' \
...
🏁 🍇
  ...
  💭 Query parameters
  🔤sessionId=13b76929-381f-48b6-a7a6-ae9cd26e95cc🔤 ➡️ sessionId
  ...
  "activeSessions": [
    {
      ...
      "lastActivity": 1780520731794,
      "sessionId": "13b76929-381f-48b6-a7a6-ae9cd26e95cc",
      "startedAt": 1780520731794,
      "systemId": "dnd5e",
