...
```bash
curl -X DELETE 'http://localhost:3010/end-session?sessionId=030a1249-70e5-41a8-8bd3-26cfeb39faab' \
...
🏁 🍇
  ...
  💭 Query parameters
  🔤sessionId=030a1249-70e5-41a8-8bd3-26cfeb39faab🔤 ➡️ sessionId
