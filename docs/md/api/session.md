...
```json
{
  ...
  "sessionId": "9f46f802-6798-4e6b-a587-3d3cf849336a",
  "success": true
}
```
...
```bash
curl -X DELETE 'http://localhost:3011/end-session?sessionId=9f46f802-6798-4e6b-a587-3d3cf849336a' \
...
🏁 🍇
  ...
  💭 Query parameters
  🔤sessionId=9f46f802-6798-4e6b-a587-3d3cf849336a🔤 ➡️ sessionId
  🔤?🧲sessionId🧲🔤 ➡️ queryString

  💭 Build HTTP request
  🔤DELETE /end-session🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```bash
curl -X GET 'http://localhost:3011/session' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /session HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
  ...
  "activeSessions": [
    {
      ...
      "lastActivity": 1782956904314,
      "sessionId": "9f46f802-6798-4e6b-a587-3d3cf849336a",
      "startedAt": 1782956904314,
      "systemId": "dnd5e",
