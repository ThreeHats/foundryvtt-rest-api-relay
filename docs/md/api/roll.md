...
```bash
curl -X GET 'http://localhost:3010/rolls?clientId=fvtt_d3db244ce1d8af0b&limit=20' \
...
{
  "type": "rolls-result",
  "requestId": "rolls_1780520764944",
  "data": [
    {
      "id": "manual_1780520764439_n5ejlptjfhs",
      "messageId": "manual_1780520764439_n5ejlptjfhs",
      "user": null,
      "speaker": {},
      "flavor": "Test Roll",
      "rollTotal": 3,
...
```bash
curl -X GET 'http://localhost:3010/lastroll?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here"
```
...
```json
{
  ...
  "requestId": "last-roll_1780520764949",
  "data": {
    "id": "manual_1780520764439_n5ejlptjfhs",
    "messageId": "manual_1780520764439_n5ejlptjfhs",
    "user": null,
...
```bash
curl -X POST 'http://localhost:3010/roll?clientId=fvtt_d3db244ce1d8af0b' \
  -H "x-api-key: your-api-key-here" \
