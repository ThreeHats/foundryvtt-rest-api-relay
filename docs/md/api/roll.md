...
```bash
curl -X GET 'http://localhost:3011/rolls?clientId=qsl-integration-test&limit=20' \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /rolls🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
{
  "type": "rolls-result",
  "requestId": "rolls_1782956919197",
  "data": [
    {
      "id": "manual_1782956918692_n3iweer4g58",
      "messageId": "manual_1782956918692_n3iweer4g58",
      "user": null,
      "speaker": {},
      "flavor": "Test Roll",
      "rollTotal": 7,
      ...
      "timestamp": 1782956918692
    },
    {
      "id": "manual_1782956906061_padve8qsacr",
      "messageId": null,
      "user": null,
      "speaker": {},
      "flavor": "",
...
```bash
curl -X GET 'http://localhost:3011/lastroll?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here"
```
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤GET /lastroll🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌n❌r❌n🔤 ➡️ request
...
```json
{
  ...
  "requestId": "last-roll_1782956919200",
  "data": {
    "id": "manual_1782956918692_n3iweer4g58",
    "messageId": "manual_1782956918692_n3iweer4g58",
    "user": null,
...
```bash
curl -X POST 'http://localhost:3011/roll?clientId=qsl-integration-test' \
  -H "x-api-key: your-api-key-here" \
...
🏁 🍇
  ...
  💭 Build HTTP request
  🔤POST /roll🧲queryString🧲 HTTP/1.1❌r❌nHost: localhost:3011❌r❌nx-api-key: your-api-key-here❌r❌nContent-Type: application/json❌r❌nContent-Length: 66❌r❌n❌r❌n🧲body🧲🔤 ➡️ request
