<script lang="ts">
  ...
  // One-time API key modal state (signup only)
  ...
  <div class="modal-backdrop" role="dialog" aria-modal="true">
    <div class="modal">
      ...
      <div class="key-display">
        ...
        <button class="btn btn-primary" onclick={copyOneTime} type="button">
      ...
      <div class="modal-actions">
        <button class="btn btn-primary" onclick={dismissOneTimeModal} disabled={!acknowledged} type="button">
